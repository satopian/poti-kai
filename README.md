...
## 履歴
### [2022/10/23] v1.60.0 lot.221023
- 既知の深刻なセキュリティ上の問題を修正しました。  
v1.xを現在も使用しつづけている方がまだ存在しているため更新しました。  
しかしながら、テンプレート関連だけでもGitHubのセキュリティスキャンだけでも7箇所の問題点が指摘されているのが現状で脆弱性はまだ残っています。  
v1.xを使っている方で、掲示板全体を更新するのは難しいという方のみ、v1.60.0のpotiboard.phpの上書きアップデートをお願いします。  
- [POTI-board改公式サイト](https://paintbbs.sakura.ne.jp/poti/)からv5.xの最新版をダウンロードできますので、新規設置を検討されている方はv5.xをご利用ください。
...
- 投稿者名をコピーする機能を追加（対応テンプレートが必要です） (by さとぴあ)
